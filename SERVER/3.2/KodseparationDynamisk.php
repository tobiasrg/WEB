...
/*
$html_pieces[2] = str_replace('---$name---', "PATH", $html);
$html_pieces[2] = str_replace('---$value---', $path, $html);
*/

echo $html_pieces[0];

$html_pieces[1] = $temp_string;

$html_pieces[1] = str_replace('---$name---', "PATH", $temp_string);
$html_pieces[1] = str_replace('---$value---', $path, $temp_string);
echo $temp_string;
